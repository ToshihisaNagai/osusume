    ...
    <table class="table mt-5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/dashboard/major_categories/{{ $major_category->id }}" onclick="event.preventDefault(); document.getElementById('logout-form{{ $major_category->id }}').submit();" class="dashboard-delete-link">
                        削除
                    </a>

                    <form id="logout-form{{ $major_category->id }}" action="/dashboard/major_categories/{{ $major_category->id }}" method="POST" style="display: none;">
                        @csrf
