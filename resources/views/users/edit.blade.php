            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userName">
                        <h1 class="samuraimart-edit-user-info-value">{{ $user->name }}</h1>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userMail">
                        <h1 class="samuraimart-edit-user-info-value">{{ $user->email }}</h1>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userPhone">
                        <h1 class="samuraimart-edit-user-info-value">{{ $user->phone }}</h1>
                    </div>
